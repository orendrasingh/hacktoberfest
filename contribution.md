...
## we are working on making this as a web app and need an update on that with you all so for Hacktoberfest 2022 we want it to be completed by Mid October and for the same have a look at the existing isssues.
